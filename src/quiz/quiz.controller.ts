...
export class QuizController {
	...
	async updateQuestion(
		...
		return this.quizService.updateQuestion(questionId, req.user.id, questionData)
	}

	@Delete('questions/:questionId')
	@UseGuards(RoleGuard)
	@Roles('TEACHER', 'STUDENT')
	removeQuestion(@Param('questionId', ParseUUIDPipe) questionId: string, @Request() req) {
	...
	async getPracticeTestResults(@Param('attemptId', ParseUUIDPipe) attemptId: string): Promise<PracticeTestResultsResponse> {
